...
#
#-----------------------------------------#
# CREDENCIAIS DE ACESSO - FONTE DOS DADOS #
#-----------------------------------------#
$dbServerSource = 'prd_server_name'
$dbUserSource = 'user'
$dbPassSource = 'password'
$dbNameSource = 'database'
#
#-------------------------------------------#
# CREDENCIAIS DE ACESSO - DESTINO DOS DADOS #
#-------------------------------------------#
$dbServerDest = 'dev_server_name'
$dbUserDest = 'user'
$dbPassDest = 'password'
$dbNameDest = 'database'
#
